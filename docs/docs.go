        ...
        "/auth/github/link": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Platform for OAuth flow (mobile|web)",
                        "name": "platform",
                        "in": "query"
                    }
                ],
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.TeamsEnvelope"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.TeamCreationRequest"
                        }
                    }
                ],
                "responses": {
